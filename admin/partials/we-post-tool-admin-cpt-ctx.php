...
<div class="wrap">
                                ...
                                <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                    <div class="sm:col-span-3">
                                        <label for="custom_link" class="block text-sm font-medium text-gray-700">
                                            لینک سفارشی
                                            <button type="button" onclick="openInfoModal('custom_link_info')" class="text-xs ml-1 text-blue-600 hover:text-blue-800">
                                                (ℹ️ راهنما)
                                            </button>
                                        </label>
                                        ...
                                        <div class="relative flex items-start">
                                            ...
                                            <div class="mr-3 text-sm">
                                                <label for="with_front" class="font-medium text-gray-700">غیرفعالسازی لینک پایه
                                                    <button type="button" onclick="openInfoModal('with_front_info')" class="text-xs ml-1 text-blue-600 hover:text-blue-800">
                                                        (ℹ️ راهنما)
                                                    </button>
                                                </label>
                                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                    <div class="sm:col-span-2">
                                        ...
                                        <p class="mt-2 text-xs text-gray-500">نام منحصر به فرد در دیتابیس.</p>
                                    </div>
                                    <div class="sm:col-span-2">
                                ...
                                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-4 space-y-2">
                                            ...
                                            ?>
                                                <div class="relative flex items-start">
                                                    <div class="flex h-5 items-center"><input id="pt_<?php echo $post_type->name; ?>" name="post_types[]" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"></div>
                                                    <div class="mr-3 text-sm"><label for="pt_<?php echo $post_type->name; ?>" class="font-medium text-gray-700"><?php echo $post_type->label; ?></label></div>
                                                </div>
                                            <?php
                                            }
                                            ?>
    ...
    <div id="infoModal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6 relative">
            <button onclick="closeInfoModal()" class="absolute top-1 right-2 text-gray-500 hover:text-gray-800 text-xl">&times;</button>
