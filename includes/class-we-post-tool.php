...
class We_Post_Tool
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      We_Post_Tool_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - We_Post_Tool_Loader. Orchestrates the hooks of the plugin.
	 * - We_Post_Tool_i18n. Defines internationalization functionality.
	 * - We_Post_Tool_Admin. Defines all hooks for the admin area.
	 * - We_Post_Tool_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the We_Post_Tool_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
